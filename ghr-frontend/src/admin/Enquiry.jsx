...
const EnquiryManagement = () => {
  ...
  const [users, setUsers] = useState([]); // store users for joining enquirer name
  ...
  // Filter enquiries for the main table based on search query (including enquirerName)
  ...
  // When an enquiry is selected for update
  ...
  return (
    <div className="enquiry-management" style={{ padding: "1rem" }}>
